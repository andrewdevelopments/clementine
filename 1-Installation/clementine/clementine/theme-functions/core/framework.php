<?php
    ...
    if ( ! class_exists( 'ReduxFrameworkInstances' ) ) {
        // Instance Container
        require_once( trailingslashit( get_template_directory() ) . 'theme-functions/core/inc/class.redux_instances.php' );
        require_once( trailingslashit( get_template_directory() ) . 'theme-functions/core/inc/lib.redux_instances.php' );
    }
    ...
    if ( ! class_exists( 'ReduxFramework' ) ) {
        ...
        // Redux CDN class
        require_once( trailingslashit( get_template_directory() ) . 'theme-functions/core/inc/class.redux_cdn.php' );

        // Redux API class  :)
        require_once( trailingslashit( get_template_directory() ) . 'theme-functions/core/inc/class.redux_api.php' );

        // General helper functions
        require_once( trailingslashit( get_template_directory() ) . 'theme-functions/core/inc/class.redux_helpers.php' );

        // General functions
        require_once( trailingslashit( get_template_directory() ) . 'theme-functions/core/inc/class.redux_functions.php' );
        require_once( trailingslashit( get_template_directory() ) . 'theme-functions/core/inc/class.p.php' );
        require_once( trailingslashit( get_template_directory() ) . 'theme-functions/core/inc/class.thirdparty.fixes.php' );
        require_once( trailingslashit( get_template_directory() ) . 'theme-functions/core/inc/class.redux_filesystem.php' );
        require_once( trailingslashit( get_template_directory() ) . 'theme-functions/core/inc/class.redux_admin_notices.php' );

        // ThemeCheck checks
        require_once( trailingslashit( get_template_directory() ) . 'theme-functions/core/inc/themecheck/class.redux_themecheck.php' );

        // Welcome
        require_once( trailingslashit( get_template_directory() ) . 'theme-functions/core/inc/welcome/welcome.php' );
        ...
        class ReduxFramework {
            ...
            public static function init() {
                $dir = Redux_Helpers::cleanFilePath( get_template_directory() . '/theme-functions/core/' );
            ...
            private function _tracking() {
                ...
                if ( file_exists( get_template_directory() . '/theme-functions/core/' . '' ) ) {
                    require_once( trailingslashit( get_template_directory() ) . 'theme-functions/core/inc/tracking.php' );
            ...
            private function _register_extensions() {
                $path    = trailingslashit( get_template_directory() ) . 'theme-functions/core/inc/extensions/';
