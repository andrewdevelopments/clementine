	...
	<?php if( !is_single() ) : ?>
		<header class="entry-header <?php if( !has_post_thumbnail() || $audio ) : echo 'no-thumbnail'; endif;?> <?php if( $fullheight_article == 'on' || has_post_thumbnail() && $fullheight_article == '' ) : echo 'fullheight-thumbnail'; endif; ?> <?php if( ( _clementine_get_option_('adD_custom_excerpt_length') || strpos($post->post_content, '<!--more-->') ) && ( $fullheight_article == 'off' || $fullheight_article == '' ) ) :  echo 'has-content'; endif; ?>">
			<?php if( !$audio && has_post_thumbnail() && $fullheight_article == 'off' ) : ?>
				...
				<!-- End Post Media -->
			<?php elseif( !$audio && has_post_thumbnail() && $fullheight_article == 'on' ) : ?>
				<!-- Full height media -->
				<div class="post-media">
					<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
			...
			<?php elseif( !$audio && has_post_thumbnail() && $fullheight_article == '' ) : ?>
				<!-- Normal media -->
				<div class="post-media">
					<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
