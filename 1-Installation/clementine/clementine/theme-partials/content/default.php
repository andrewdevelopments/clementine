...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php if( !is_single() ) : ?>
		<header class="entry-header <?php if( !has_post_thumbnail() ) : echo 'no-thumbnail'; endif;?> <?php if( $fullheight_article == 'on' ) : echo 'fullheight-thumbnail'; endif; ?> <?php if( ( _clementine_get_option_('adD_custom_excerpt_length') || strpos($post->post_content, '<!--more-->') ) && ( $fullheight_article == 'off' || $fullheight_article == '' ) ) :  echo 'has-content'; endif; ?>">
